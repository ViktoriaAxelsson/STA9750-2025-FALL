...
### Acquire Data and Improve the Data Objects 
<br>
```{r setup}
#| include: false
...
* Stranger Things is one of Netflix biggest English hit shows ever made. It is the **4th longest-running show** on Netflix’s Global Top 10 list (English-Langauge).

<br>

Netflix’s Global Top 10 list (longest-running English-Language shows on the Top 10 List):
...
* Stranger Things will debut its final season in three volumes this fall: four episodes on Nov. 26, three episodes on Christmas, and the finale episode on New Year’s Eve. Each volume releases at 5 p.m. PST
...
## <span style="color: darkred;">Growing Customer Base: India Can’t Get Enough of Netflix</span>
